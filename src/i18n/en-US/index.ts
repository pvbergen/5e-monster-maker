export default {
  ...
  editor: {
    ...
    monsterarchive: {
      ...
      actions: 'Actions',
      import: 'Import monster archive',
      export: 'Export all monsters as archive | Export monster as archive | Export {n} monsters as archive',
      export_single: 'Export monster as 5emm json',
      save_current: 'Save current monster',
      overwrite_save_current: 'Save current monster before overwrite?',
      overwrite_current_no: 'Ignore',
      overwrite_current_yes: 'Save',
      load: 'Load monster into builder',
      loaded: 'Monster loaded successfully',
      loadError: 'Monster could not be loaded: {0}',
      new_save: 'Save as new entry',
      overwrite_saved: 'Monster has been successfully updated.',
      not_overwritten: 'Monster has not been updated.',
      saved: 'Monster has been successfully saved.',
      delete: 'Delete | Delete Monster | Delete {n} Monsters',
      delete_confirmation: 'No monster to delete | Delete monster "{n}"? | Delete {n} monsters?',
      importDialog: 'Import Monster Archive',
      importFile: 'Pick monster archive File',
      importMode: 'Overwrite monsters with same ID?',
